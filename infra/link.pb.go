...
type WatchLocalLinksResponse struct {
	...
	LastRead      *timestamp.Timestamp   `protobuf:"bytes,7,opt,name=last_read,json=lastRead,proto3" json:"last_read,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WatchLocalLinksResponse) GetLastRead() *timestamp.Timestamp {
	if x != nil {
		return x.LastRead
	}
	return nil
