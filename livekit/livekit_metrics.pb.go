...
type MetricsBatch struct {
	...
	NormalizedTimestamp *timestamp.Timestamp   `protobuf:"bytes,2,opt,name=normalized_timestamp,json=normalizedTimestamp,proto3" json:"normalized_timestamp,omitempty"`
...
func (x *MetricsBatch) GetNormalizedTimestamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *MetricSample) GetNormalizedTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.NormalizedTimestamp
	}
	return nil
...
type EventMetric struct {
	...
	NormalizedStartTimestamp *timestamp.Timestamp   `protobuf:"bytes,6,opt,name=normalized_start_timestamp,json=normalizedStartTimestamp,proto3" json:"normalized_start_timestamp,omitempty"`
	NormalizedEndTimestamp   *timestamp.Timestamp   `protobuf:"bytes,7,opt,name=normalized_end_timestamp,json=normalizedEndTimestamp,proto3,oneof" json:"normalized_end_timestamp,omitempty"`
...
func (x *EventMetric) GetNormalizedStartTimestamp() *timestamp.Timestamp {
	if x != nil {
...
func (x *EventMetric) GetNormalizedEndTimestamp() *timestamp.Timestamp {
	if x != nil {
