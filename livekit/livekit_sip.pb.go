...
type SIPInboundTrunkInfo struct {
	...
	RingingTimeout *duration.Duration `protobuf:"bytes,11,opt,name=ringing_timeout,json=ringingTimeout,proto3" json:"ringing_timeout,omitempty"`
	// Max call duration.
	MaxCallDuration *duration.Duration `protobuf:"bytes,12,opt,name=max_call_duration,json=maxCallDuration,proto3" json:"max_call_duration,omitempty"`
...
func (x *SIPInboundTrunkInfo) GetRingingTimeout() *duration.Duration {
	if x != nil {
...
func (x *SIPInboundTrunkInfo) GetMaxCallDuration() *duration.Duration {
	if x != nil {
...
func (x *CreateSIPParticipantRequest) GetRingingTimeout() *duration.Duration {
	if x != nil {
		return x.RingingTimeout
	}
	return nil
...
func (x *CreateSIPParticipantRequest) GetMaxCallDuration() *duration.Duration {
	if x != nil {
		return x.MaxCallDuration
	}
	return nil
