...
func (x *AgentSecret) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *AgentSecret) GetUpdatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
type AgentInfo struct {
	...
	DeployedAt       *timestamp.Timestamp   `protobuf:"bytes,6,opt,name=deployed_at,json=deployedAt,proto3" json:"deployed_at,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *AgentInfo) GetDeployedAt() *timestamp.Timestamp {
	if x != nil {
		return x.DeployedAt
	}
	return nil
...
func (x *AgentVersion) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
