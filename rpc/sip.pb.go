...
type InternalCreateSIPParticipantRequest struct {
	...
	RingingTimeout *duration.Duration `protobuf:"bytes,23,opt,name=ringing_timeout,json=ringingTimeout,proto3" json:"ringing_timeout,omitempty"`
	// Max call duration.
	MaxCallDuration *duration.Duration         `protobuf:"bytes,24,opt,name=max_call_duration,json=maxCallDuration,proto3" json:"max_call_duration,omitempty"`
...
func (x *InternalCreateSIPParticipantRequest) GetRingingTimeout() *duration.Duration {
	if x != nil {
...
func (x *InternalCreateSIPParticipantRequest) GetMaxCallDuration() *duration.Duration {
	if x != nil {
