...
type EvaluateSIPDispatchRulesResponse struct {
	...
	RingingTimeout *duration.Duration `protobuf:"bytes,16,opt,name=ringing_timeout,json=ringingTimeout,proto3" json:"ringing_timeout,omitempty"`
	// Max call duration.
	MaxCallDuration *duration.Duration `protobuf:"bytes,17,opt,name=max_call_duration,json=maxCallDuration,proto3" json:"max_call_duration,omitempty"`
...
func (x *EvaluateSIPDispatchRulesResponse) GetRingingTimeout() *duration.Duration {
	if x != nil {
...
func (x *EvaluateSIPDispatchRulesResponse) GetMaxCallDuration() *duration.Duration {
	if x != nil {
